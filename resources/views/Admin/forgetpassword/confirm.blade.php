    ...
    <div class="row px-3">
      <div class="col-lg-7 col-xl-5 card flex-row mx-auto px-0">
        ...
        <div class="card-body">
          ...
          <form class="form-box px-3" method="post" action="{{route('forget.confirm')}}">
            @csrf
            <div class="form-input" style="display: none;">
              <span><i class="fa-solid fa-envelope"></i></i></span>
              <input type="email" name="email" value="{{ session('email') ?? '' }}" placeholder="Email Address" tabindex="10" required>
            </div>
            <div class="form-input" style="display: none;">
              <span><i class="fa-solid fa-lock"></i></span>
              <input type="text" name="token" value="{{ session('token') ?? '' }}" placeholder="Enter OTP" required>
            </div>
